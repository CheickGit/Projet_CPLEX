...
#include <ilcplex/cplex.h>     // Pour CPXENVptr, CPXLPptr et CPXstrongbranch
#include <vector>
#include <pybind11/embed.h>  // permet l'appel à Python
#include <list>
#include <string>
#include <fstream>
#include <iostream>
#include <iomanip>
#include <sstream>
#include <cmath> // Ajout pour std::abs
...
public:
    ...
    void create_model(); // Changé de void à bool
	// resolve o problema
    ...
    //void init_data_collection(const std::string& filename);
    bool solve_with_ml(const std::string &instance);
